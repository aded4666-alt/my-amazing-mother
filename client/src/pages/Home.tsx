...
const memories = [
  { number: "01", title: "the laugh that fills our home", tone: "sunrise" },
  { number: "02", title: "the heart of every gathering", tone: "golden" },
  { number: "03", title: "some moments need no captions", tone: "lavender" },
  { number: "04", title: "a light in every room", tone: "night" },
  { number: "05", title: "our forever favorite person", tone: "rose" },
];

const whatsappUrl = "mailto:?subject=Happy birthday, Mom!&body=I just saw your birthday surprise — I love you!";
    ...
    <main className="site-shell">
      ...
      <section id="top" className="hero-section">
        ...
        <div className="hero-content">
          <div className="eyebrow reveal"><span className="eyebrow-line" /> A colorful birthday celebration <span className="eyebrow-line" /></div>
          <p className="hero-date reveal delay-1">23 <span>·</span> 09 <span>·</span> 2026</p>
          <h1 className="hero-title reveal delay-2">Happy Birthday,<br /><em>My Adorable Mother</em> <span className="crown">♛</span></h1>
          <p className="hero-intro reveal delay-3">Today we celebrate the woman whose love makes every room feel like home.<br />Every color, every memory, every word here is wrapped in love for you.</p>
        ...
        <div className="hero-footer">
          <span>made with love, bright colors,<br />and a lifetime of gratitude.</span>
      ...
      <section className="date-section section-pad" aria-label="Birthday date">
        <div className="date-card">
          ...
          <div className="date-display"><span>September</span><strong>23</strong><span>two thousand twenty-six</span></div>
          <div className="date-caption">the day the world got a little more beautiful</div>
          <Sparkles className="date-spark" size={18} />
        </div>
        <div className="date-note"><span className="scribble">✦</span><p>For the woman who makes<br /><em>ordinary days brighter.</em></p></div>
      </section>
      ...
      <section className="countdown-section section-pad">
        <div className="countdown-copy"><span className="section-kicker">the countdown</span><h2>Celebrating your <em>day</em></h2><p>september 23 · 2026</p></div>
      ...
      <section className="wishes-section section-pad">
        ...
        <div className="wish-grid">{[
          ["01", "Joy in the little things", "May your mornings be joyful, your tea be warm, and every little moment remind you how loved you are."],
          ["02", "Soft days ahead", "May this year bring you dancing, laughter, good health, and beautiful surprises."],
          ["03", "Big dreams, always", "May you feel celebrated every day, because our lives are brighter simply because you are in them."],
      ...
      <section id="letter" className="letter-section section-pad">
        <div className="letter-intro"><span className="section-kicker">sealed with love</span><h2>A letter<br />for <em>Mom</em></h2><p>Some things are easier to say<br />when they&apos;re written down.</p><button className="text-button" onClick={() => setLetterOpen(true)}>open the letter <ArrowUpRight size={16} /></button></div>
        <button className={`envelope ${letterOpen ? "opened" : ""}`} onClick={() => setLetterOpen(true)} aria-label="Open birthday letter">
          <div className="envelope-top" /><div className="envelope-body"><div className="envelope-date"><strong>23</strong><span>to</span><strong>My Adorable Mother</strong></div><Heart className="envelope-heart" size={26} fill="currentColor" /><span className="envelope-hint"><LockKeyhole size={13} /> tap the seal to open</span></div>
        </button>
        <div className="letter-date">23 · 09 · 2026</div>
      </section>
      ...
      <section className="secret-section section-pad">
        <div className="secret-panel"><div className="secret-copy"><span className="section-kicker">one more thing</span><h2>A secret, <em>hidden</em> for you</h2><p>Scratch the panel below to uncover it.</p></div><button ref={secretRef} className={`scratch-panel ${scratched ? "revealed" : ""}`} onClick={() => setScratched(true)}><span className="scratch-cover">{scratched ? <Check size={20} /> : <Sparkles size={20} />}<b>{scratched ? "uncovered" : "scratch here"}</b></span><span className="secret-message">You are, and always will be,<br /><em>our favorite person.</em> 💛</span></button><p className="scratch-instruction">use your finger or mouse to scratch</p></div>
      </section>
      ...
      <section className="keepsake-section section-pad">
        ...
        <div className="keepsake-card"><div className="keepsake-stars">✦ ✦ ✦</div><div className="keepsake-label">a keepsake for Mom</div><div className="keepsake-name">My Adorable Mother</div><div className="keepsake-date">23 · 09 · 2026</div><ol><li>for endless joy</li><li>for sunny days</li><li>for every dream you hold</li><li>and for you — always</li></ol><div className="keepsake-sign">— Dayo 😎</div><div className="keepsake-bottom">✦ ✦ ✦</div></div>
      </section>

      <footer className="site-footer"><div className="footer-flower">✿</div><div><p>some sites are built with code —<br /><em>this one was built with a whole lot of love.</em></p><span>Made with <Heart size={13} fill="currentColor" /> by Dayo 😎 · your forever child</span></div><a href={whatsappUrl} target="_blank" rel="noreferrer" className="whatsapp-link"><MessageCircle size={17} /> Say thank you <Heart size={13} fill="currentColor" /></a></footer>
      ...
      {letterOpen && <div className="modal-backdrop" onClick={() => setLetterOpen(false)}><article className="letter-modal" onClick={(event) => event.stopPropagation()}><button className="modal-close" onClick={() => setLetterOpen(false)} aria-label="Close letter"><X size={17} /></button><div className="modal-kicker">23 · 09 · 2026</div><div className="modal-stamp">✦</div><h2>Dear <em>Mom,</em></h2><p>Happy birthday to the most wonderful mother I know. Today we celebrate your kindness, your strength, and the love you pour into all of us.</p><p>I wanted to build something just for you: a colorful little corner of the internet where every pixel says thank you for every hug, every lesson, and every sacrifice.</p><p>May your new year be full of health, dancing in the kitchen, laughter around the table, and all the beautiful things you deserve.</p><p>I love you more than words can say, Mom. <Heart size={15} fill="currentColor" /></p><div className="modal-signoff"><span>with love</span><strong>Dayo 😎</strong><small>your forever child</small></div><a className="button button-dark modal-whatsapp" href={whatsappUrl} target="_blank" rel="noreferrer"><MessageCircle size={15} /> Send Mom some love</a></article></div>}
    </main>
  );
}
